...
#' @param censor.index censoring index indicating the censored data in the original datset
#'
...
visual.plot <- function(data,
  ...
  # (1) if all variable have either missing or censored values
