...
// // [[Rcpp::export]]
// List multiple_imputation(const List data,
//                          const List prior_params,
//                          const List start_vals,
//                          const int niter,
//                          bool verbose = true) {
//
//   // single imputation to make up incomplete data
//   NumericMatrix iter_data = single_imputation(data);
//
//   // number of observations and variables
//   const NumericMatrix ll = data[0], ul = data[1];
//   const int n = ll.nrow(), p = ll.ncol();
//
//   /*************************/
//   // prior specification
//   const double mu_0 = prior_params[0];
//   // const NumericMatrix Lambda_0 = prior_params["Lambda.0"];
//   // const int kappa_0 = prior_params["kappa.0"];
//   // const int nu_0 = prior_params["nu.0"];
//
//   // // starting values
//   // NumericVector mu_iter = start_vals["mu"];
//   // NumericVector sig_iter = start_vals["sigma"];
//   //
//   // // vector and list to store results
//   // NumericMatrix Mu_iter(niter + 1, p);
//   // NumericMatrix Sig_iter(niter + 1, p);
//   //
//   // // set the first set of values as the starting values
//   // Mu_iter(0, _) = mu_iter;
//   // Sig_iter(0, _) = sig_iter;
//   //
//   // // posterior parameters that do not depend on the data
//   // const int kappa_n = kappa_0 + n;
//   // const int nu_n = nu_0 + n;
//   //
//   // NumericMatrix cond_p(p, p + 1);
//   //
//   // for (int iter = 1; iter <= niter + 1; iter++) {
//   //
//   //   // 1. update data
//   //   cond_p = cond_param(iter_data);
//   //
//   //
//   // }
//
//   return List::create(iter_data);
//
// }
