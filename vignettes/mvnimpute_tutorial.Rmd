...
Here we generate a 5-dimensional multivariate normal data using the **data.gen** function in this package, with 2 subject to missing (MAR) and 2 to interval censoring. 
